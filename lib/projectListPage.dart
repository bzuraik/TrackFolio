                ...
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        CircleAvatar(
                          backgroundImage: NetworkImage('${projects[index].projectImage}'),
                          radius: 30.0,
                        ),
                        Container(
                          padding: EdgeInsets.all(10.0),
                          child: Text('${projects[index].projectName}', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: Color(0xFF003B57),),),
                        ),
                      ],
                    ),
                  );
