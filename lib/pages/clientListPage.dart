...
class _BodyWidgetState extends State<BodyWidget> {
  @override
  Widget build(BuildContext context) {
    final List<Client> clients = ClientDetails().clientList;
    return SafeArea(
        child: Column(
          children: <Widget>[
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        CircleAvatar(
                          backgroundImage: NetworkImage('${clients[index].clientImage}'),
                          radius: 30.0,
                        ),
                        Container(
                          padding: EdgeInsets.all(10.0),
                          child: Text('${clients[index].clientName}', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: Color(0xFF003B57),),),
                        ),
                      ],
                    ),
                  );
